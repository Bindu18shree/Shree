...
public class MarksVerificationException extends RuntimeException {

	public MarksVerificationException() {

		System.err.println("You are not eligibile to join the 1st std");
	}

	public static void age() {

		System.err.println("You must be seven or more than that to join 1st std.");
	}
