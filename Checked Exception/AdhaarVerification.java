...
import com.xworkz.checkedexception.events.AdhaarVerificationException;
...
public class AdhaarVerification {
	...
	public AdhaarVerification(int age, String password, Long phoneNumber, String name, String email, Integer batch) throws Exception{
		...
		if (batch.toString().contains("234")) {
			...
			throw new AdhaarVerificationException();
		}
	}
