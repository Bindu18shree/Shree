...
public class MarksVerification {
	...
	public MarksVerification(int age, String password, Long phoneNumber, String name, String email, Integer batch) {

		if (age > 18 && age < 50) {

			System.out.println("You're age is valid to write the GATE Exam");
		} else {
